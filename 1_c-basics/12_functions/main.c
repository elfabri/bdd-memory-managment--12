/*
Write a max_sneklang_memory function in the space provided.
It should accept two arguments:
    int max_threads
    int memory_per_thread
It should return an integer representing the total memory
available to the Sneklang interpreter.
*/
